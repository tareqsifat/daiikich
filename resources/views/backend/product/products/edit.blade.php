                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a href="{{route('product.rank.qualification',['id' => $product->id])}}"
                                               class="aiz-switch aiz-switch-success mb-0"
                                               onchange="toggleCheckbox(event)">
                                                <input type="checkbox" class="aiz-switch-input" id="checkbox1" value="1"
                                                       @if($product->rank_qualification == 1) checked @endif>
...
{{--        Modify Here--}}
        <div class="card">
            <form id="myForm" action="{{route('product.sharing.cost',['id' => $product->id])}}" method="post">
                @csrf
                <div class="card-header">
                    <h5 class="mb-0 h6">Product Affiliate Direct Commission</h5>
                </div>
                <div class="card-body">
                    <div class="form-group mb-3">
                        <label for="name">Commission (%)</label>
                        <input id="myInput" type="number" name="product_wise_commission"  class="form-control"
                               value="{{$product->product_wise_commission}}">
                    </div>
