                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-3">
                                            <div class="card">
                                                <div class="form-box-content p-3">
                                                    <div class="form-group">
                                                        <a target="_blank" href="{{'http://twitter.com/share?text=Join British Market Place and get Discount&url=https://britishmarketplace.co.uk' }}">
                                                            <i>
                                                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="48px" height="48px">
                                        ...
                                        <div class="col-md-3">
                                            <div class="card share_whatsapp">
                                                <div class="form-box-content p-3">
                                                    <div class="form-group">
                                                        <a target="_blank" href="{{'https://web.whatsapp.com/send?text=Join British Market Place and get Discount https://britishmarketplace.co.uk' }}" data-action="share/whatsapp/share">
                                                            <i>
