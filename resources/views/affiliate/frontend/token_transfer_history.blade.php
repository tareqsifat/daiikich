            ...
            <div class="aiz-user-panel">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{ translate('Affiliate token transfer history')}}</h5>
                    </div>
                    <div class="card-body">
                        <table class="table aiz-table mb-0">
                            ...
                            <tbody>
                            @foreach ($affiliate_token_transfer as $key => $affiliate_withdraw_request)
                            <tr>
                                <td>{{ $key+1 }}</td>
                        ...
                        <div class="aiz-pagination">
                            {{ $affiliate_token_transfer->links() }}
                        </div>
                    </div>
                </div>
